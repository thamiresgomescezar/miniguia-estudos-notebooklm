# README.md
# Miniguia de Estudos: IA para Produtividade e Organização Pessoal

> **Desafio de Projeto DIO:** Aprendizagem ativa, curadoria de fontes e documentação prática utilizando o **NotebookLM** como assistente de organização do conhecimento.
...
Abaixo estão registrados os testes de consultas aplicados no NotebookLM e a evolução do raciocínio durante o processo:

### Teste 1: Construção de Rotina de Estudos
- **Prompt Utilizado:** `"Como criar uma rotina de estudos com IA?"`
- **Comportamento da IA:** A ferramenta gerou inicialmente orientações genéricas. Refinou a resposta destacando a necessidade de um *briefing* detalhado (objetivo, tempo livre diário, nível de dificuldade e formato da avaliação).
- **Aprendizado:** Para obter um cronograma aplicável, é fundamental alimentar a IA com limitações reais de tempo e metas fracionadas em teoria, prática, revisão e diagnóstico.

### Teste 2: Escrita Acadêmica e Integridade Ética
- **Prompts Utilizados:** 
  - `"Quais IAs ajudam na escrita acadêmica?"`
  - `"Como detectar plágio em textos acadêmicos?"`
  - `"Como declarar o uso de IA em um trabalho?"`
- **Comportamento da IA:** A IA diferenciou o uso de assistentes de busca e escrita (ex.: Perplexity, Elicit, Quillbot) do uso indevido que gera plágio. O retorno reforçou a necessidade de declarar explicitamente no trabalho metodológico como as ferramentas foram consultadas.
...
| :--- | :--- | :--- |
| **Briefing de Prompt** | Contexto detalhado fornecido à IA com metas, prazos e limitações. | `"Tenho 1h por dia durante 30 dias para estudar fração..."` |
| **Estudo Ativo** | Prática de testar o conhecimento e corrigir falhas em vez de apenas ler passivamente. | Responder simulados e pedir para a IA explicar as lacunas. |
| **Declaração de IA** | Nota transparente no documento informando quais ferramentas foram usadas. | Inserir em metodologia: *"Uso de IA para revisão gramatical e resumos."* |
| **Alucinação da IA** | Quando a IA gera fatos incorretos ou referências inexistentes com tom de certeza. | Validar citação de artigo diretamente na base oficial ou fonte. |
...
```text
[Prompt 1 - Tutor Personalizado de Estudos]
"Atue como um tutor de estudos. Crie uma rotina semanal para mim com base nisto: [Insira o assunto] para uma prova em [X dias]. Tenho [X horas] por dia. Tenho dificuldade em [Assunto]. O plano deve conter metas diárias, exercícios e revisão."

[Prompt 2 - Explicação e Simplificação]
"Explique o conceito de [Tema Complexo] de forma simples, como se eu estivesse no primeiro período da faculdade, usando 2 analogias do cotidiano."

[Prompt 3 - Diagnóstico de Erros]
"Aqui estão minhas respostas de um simulado sobre [Assunto]: [Cole suas respostas]. Identifique quais conceitos eu errei, explique a lógica correta e sugira o que devo revisar."
